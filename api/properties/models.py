...
class Property(TimeStampedUUIDModel):
    ...
    state = models.CharField(verbose_name=_("State"), max_length=180, default="Niger")
    city = models.CharField(verbose_name=_("City"), max_length=180, default="Minna")
    postal_code = models.CharField(
        verbose_name=_("Postal Code"), max_length=100, default="140"
    )
    street_address = models.CharField(
        verbose_name=_("Street Address"), max_length=150, default="Kpakungu roundabout"
    )
    ...
    agent_fee = models.DecimalField(
        verbose_name=_("Agent Fee"),
        max_digits=6,
        decimal_places=2,
        default=0.10,
        help_text="10% property agent fee charged",
    )
    ...
    def final_property_price(self):
        agent_fee_percentage = self.agent_fee
        property_price = self.price
        agent_fee_amount = round(agent_fee_percentage * property_price, 2)
        price_after_agent_fee = float(round(property_price + agent_fee_amount, 2))
        return price_after_agent_fee
